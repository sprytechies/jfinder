                    <?php 
                    $i=Yii::app()->session['range']+1;
                    foreach ($data as $value) { 
                     $res=getAppliedId($value['idjobs']);
                              ...
                              <div class="post">
                                ...
                                <div class="collapse-data">
                                  ...
                                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore 
                                    et dolore magna aliqua. Ut  cupidatat non proident, sunt in culpa 
                                  ...
                                  <input type="hidden" id="saved_jobid<?php echo $value['idjobs']; ?>" value="<?php if(isset($res_saved)){echo $res_saved;}else{echo $res_saved;}?>">
                                    <li><a href="javascript:void(0)" 
                                      ...
                                      echo "class='save-apply'"; 
                                          ...
                                          echo "class='apply'"; 
                                        } ?> id="save_button_<?php echo $value['idjobs']; ?>" role="button" data-toggle="modal" onclick="save_process(<?php echo $value['idjobs'];?>)"><span class="glyphicon glyphicon-retweet"></span>Save</a></li>                                  <li><a href="javascript:void(0)" class="report"><span class="glyphicon glyphicon-star"></span>Report</a></li>
                                </ul>
                                </div>
