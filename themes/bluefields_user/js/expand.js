...
$.fn.expandAll = function(options) {
    ...
    return this.each(function(index) {
        ...
        // --- functions:
       (o.switchPosition == 'after') ? ($.fn.findSibling = $.fn.prev, $.fn.insrt = $.fn.before) : ($.fn.findSibling = $.fn.next, $.fn.insrt = $.fn.after);
        ...
        (o.oneSwitch) ? ($referent.insrt('<p class="switch"><a href="#" class="' + toggleClass + '"><span class="glyphicon glyphicon-download"></span>' + toggleTxt + '</a></p>')) :
